...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_save_grade(self):
        ...
        # เขาเปิดไปที่หน้า result เทอมที่ 1 เพื่อทำการเช็คว่าวิชาที่เขาลงทะเบียนนั้นถูกต้องไหม
        ...
        # เขาเช็คชหน่วยกิต
        self.assertIn('2', check_result)
        self.assertIn('3', check_result)
        ...
        self.assertIn('1', check_result)
        self.assertIn('1.5', check_result)
